...
/* State definitions for flag_LOOPSEARCHTEST */
typedef enum { flag_LOOPSEARCHTESTMIN = -1,
         flag_LOOPSEARCHTESTLOGICAL,
         flag_LOOPSEARCHTESTSUBSUMPTION,
         flag_LOOPSEARCHTESTMAX
} FLAG_LOOPSEARCHTESTTYPE;

/* State definitions for flag_LOOPSEARCHITERATIONS */
typedef enum { flag_LOOPSEARCHITERATIONSMIN = 1,
         flag_LOOPSEARCHITERATIONSMAX = INT_MAX
} FLAG_LOOPSEARCHITERATIONSTYPE;

/* State definitions for flag_SEQUENTIALLOOPSEARCH */
typedef enum { flag_SEQUENTIALLOOPSEARCHMIN = -1,
         flag_SEQUENTIALLOOPSEARCHOFF = flag_OFF,
         flag_SEQUENTIALLOOPSEARCHON  = flag_ON,
         flag_SEQUENTIALLOOPSEARCHMAX
} FLAG_SEQUENTIALLOOPSEARCHTYPE;

/* State definitions for flag_PDIFFMARK */
typedef enum { flag_PDIFFMARKMIN = -1,
         flag_PDIFFMARKOFF = flag_OFF,
         flag_PDIFFMARKON  = flag_ON,
         flag_PDIFFMARKMAX
} FLAG_PDIFFMARKTYPE;

/* State definitions for flag_PLOOPCAND */
typedef enum { flag_PLOOPCANDMIN = -1,
         flag_PLOOPCANDOFF = flag_OFF,
         flag_PLOOPCANDON  = flag_ON,
         flag_PLOOPCANDMAX
} FLAG_PLOOPCANDTYPE;

/* State definitions for flag_SEQUENTIALLOOPSEARCHITERATIONS */
typedef enum { flag_SEQUENTIALLOOPSEARCHITERATIONSMIN = 1,
         flag_SEQUENTIALLOOPSEARCHITERATIONSMAX = INT_MAX
} FLAG_SEQUENTIALLOOPSEARCHITERATIONSTYPE;

/* State definitions for flag_MODELCONSTRUCTION */
typedef enum { flag_MODELCONSTRUCTIONMIN = -1,
         flag_MODELCONSTRUCTIONOFF = flag_OFF,
         flag_MODELCONSTRUCTIONON  = flag_ON,
         flag_MODELCONSTRUCTIONMAX
} FLAG_MODELCONSTRUCTIONTYPE;

/* State definitions for flag_PMODELCONSTRUCTIONSTEPS */
typedef enum { flag_PMODELCONSTRUCTIONSTEPSMIN = -1,
         flag_PMODELCONSTRUCTIONSTEPSOFF = flag_OFF,
         flag_PMODELCONSTRUCTIONSTEPSON  = flag_ON,
         flag_PMODELCONSTRUCTIONSTEPSMAX
} FLAG_PMODELCONSTRUCTIONSTEPSTYPE;

/* State definitions for flag_MODELCONSTRUCTIONTYPE */
typedef enum { flag_MODELCONSTRUCTIONTYPEMIN = -1,
	       flag_ORDEREDMODELCONSTRUCTION,
	       flag_UNORDEREDMODELCONSTRUCTION,
	       flag_MODELCONSTRUCTIONTYPEMAX
} FLAG_MODELCONSTRUCTIONTYPEVALUES;

/* State definitions for flag_UNORDEREDFINEGRAINEDRESOLUTION */
typedef enum { flag_UNORDEREDFINEGRAINEDSTEPRESOLUTIONMIN = -1,
         flag_UNORDEREDFINEGRAINEDSTEPRESOLUTIONOFF = flag_OFF,
         flag_UNORDEREDFINEGRAINEDSTEPRESOLUTIONON  = flag_ON,
         flag_UNORDEREDFINEGRAINEDSTEPRESOLUTIONMAX
} FLAG_UNORDEREDFINEGRAINEDSTEPRESOLUTION;

/* State definitions for flag_ELIMINATEREDUNDANTCYCLES */
typedef enum { flag_ELIMINATEREDUNDANTCYCLESMIN = -1,
	       flag_ELIMINATEREDUNDANTCYCLESOFF = flag_OFF,
	       flag_ELIMINATEREDUNDANTCYCLESON = flag_ON,
	       flag_ELIMINATEREDUNDANTCYCLESMAX
} FLAG_ELIMINATEREDUNDANTCYCLESVALUES;
...
typedef enum { flag_AUTO, flag_STDIN, flag_INTERACTIVE, flag_FLOTTER,
         ...
         flag_LOOPSEARCHTEST, flag_LOOPSEARCHITERATIONS, flag_SEQUENTIALLOOPSEARCH,

         flag_PDIFFMARK, flag_PLOOPCAND, flag_SEQUENTIALLOOPSEARCHITERATIONS,
         flag_MODELCONSTRUCTION, flag_PMODELCONSTRUCTIONSTEPS, flag_MODELCONSTRUCTIONTYPE,

         flag_UNORDEREDFINEGRAINEDSTEPRESOLUTION, flag_ELIMINATEREDUNDANTCYCLES,
...
BOOL        flag_IsInternal(FLAG_ID Flag);
...
static __inline__ BOOL flag_IsModelConstructionEnabled(FLAGSTORE Store)
{
  return !flag_ValueIsClean(Store, flag_MODELCONSTRUCTION)
         && flag_GetFlagValue(Store, flag_MODELCONSTRUCTION) == flag_MODELCONSTRUCTIONON;
}

static __inline__ BOOL flag_IsUnorderedModelConstructionEnabled(FLAGSTORE Store)
{
  return flag_IsModelConstructionEnabled(Store)
         && !flag_ValueIsClean(Store, flag_MODELCONSTRUCTIONTYPE)
         && flag_GetFlagValue(Store, flag_MODELCONSTRUCTIONTYPE) == flag_UNORDEREDMODELCONSTRUCTION;
}

static __inline__ BOOL flag_UnorderedFineGrainedStepResolution(FLAGSTORE Flags)
{
  return flag_GetFlagValue(Flags, flag_UNORDEREDFINEGRAINEDSTEPRESOLUTION) == flag_UNORDEREDFINEGRAINEDSTEPRESOLUTIONON;
}
