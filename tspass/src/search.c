...
{
  LIST Scan;
//still delete the eventualityclauses!
...
***************************************************************/
{
  ...
  Search->eventualityclauses  = list_Nil();
  ...
  Search->inputclauses                 = 0;
  Search->keptclauses                  = 0;
  Search->derivedclauses               = 0;
  Search->successfulloopsearches       = 0;
  Search->forwardsubsumedclauses       = 0;
  Search->backwardsubsumedclauses      = 0;
  Search->differentmarkerclauses       = 0;
  Search->tautologyclauses             = 0;
  Search->loops                        = 0;
  Search->backtracked                  = 0;
  Search->nontrivclausenumber          = 0;
  Search->loopsearchiterations         = 0;
...
***************************************************************/
{
  ...
  Result->eventualityclauses = list_Nil();
  ...
  Result->inputclauses                 = 0;
  Result->keptclauses                  = 0;
  Result->derivedclauses               = 0;
  Result->successfulloopsearches       = 0;
  Result->backwardsubsumedclauses      = 0;
  Result->forwardsubsumedclauses       = 0;
  Result->differentmarkerclauses       = 0;
  Result->tautologyclauses             = 0;
  Result->loops                        = 0;
  Result->backtracked                  = 0;
  Result->nontrivclausenumber          = 0;
  Result->evloopsearchinf              = NULL;
  Result->loopsearchiterations         = 0;
...
***************************************************************/
{
  ...
  fputs("\n Eventuality Clauses:", stdout);
  for (Scan=prfs_EventualityClauses(Search);!list_Empty(Scan);Scan=list_Cdr(Scan)) {
    putchar('\n');
    putchar(' ');
    clause_Print(list_Car(Scan));
  }
