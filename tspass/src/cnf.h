...
PROOFSEARCH cnf_Flotter(LIST, LIST, LIST*, LIST* InitialClauses, LIST* UniversalClauses,
                        LIST *StepClauses, LIST *EventualityClauses, HASH, HASH,
                        FLAGSTORE, PRECEDENCE, LIST*, BOOL* predicateMap);
...
LIST        cnf_QueryFlotter(PROOFSEARCH, TERM, LIST*, BOOL);
